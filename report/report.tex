...
\newcommand{\reporttitle}{Lightweight method for software product line features management} % Aspect oriented configuration of software product line features and lightweight method for their automatic, Aspect oriented configuration and derivation of software product line features
...
Next application for analysis is derivation wide range of fractals (examples of different types can be found in \cite{pelanek_programatorska_2012}) from original algorithm realized by intervention of aspects into its execution.	We assume that task of designing features for given application is determined by value of fractal appearance. For software product line creation we can request different demands for feature model such as generating all possible derivations for next aesthetic evaluation and identification of the best candidates. Because of it we evaluated potential importance of aspect oriented application for derivation of specific fractals.
\end{abstract}
