...
\newcommand{\ajset}{\lstset{emph={software product line, aspects, feature modeling, feature trees, AspectJ, fractals, automatic derivation},emphstyle=\bfseries}}

\newcommand{\reporttitle}{Lightweight aspect orientated method for software product line feature management} % Aspect oriented configuration of software product line features and lightweight method for their automatic, Aspect oriented configuration and derivation of software product line features

\pagestyle{myheadings}
\markboth{Lightweight method for software product line feature management}{Code quality, configurability and product derivation 2021/22, FIIT STU}
