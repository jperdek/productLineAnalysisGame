...
public class GraphsVertexSimilarities {

	private double matrix1[][];
	private double matrix2[][];
	
	public GraphsVertexSimilarities(double matrix1[][], double matrix2[][]) {
	...
	public static double[][] multiplyMatrixTransposedWithMatrixNewMatrix(double matrix1[][], double matrix2[][]) {
		double newMatrix[][] = new double[matrix1.length][];
		for (int rowIndex1 = 0; rowIndex1 < matrix1.length; rowIndex1++) {
			newMatrix[rowIndex1] = new double[matrix1.length];
