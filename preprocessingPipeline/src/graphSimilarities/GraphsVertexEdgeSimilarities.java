...
public class GraphsVertexEdgeSimilarities {

	private double sourceEdgeMatrix1[][];
	private double terminusEdgeMatrix1[][];
	private double sourceEdgeMatrix2[][];
	private double terminusEdgeMatrix2[][];
	...
	public GraphsVertexEdgeSimilarities(double matrix1[][], double matrix2[][]) {
		this(matrix1, matrix2, false);
	}
	
	public GraphsVertexEdgeSimilarities(double matrix1[][], double matrix2[][], boolean assignNodeLabels) {
		SourceAndTerminusEdgeMatrices sourceTerminusMatrix1 = new SourceAndTerminusEdgeMatrices(matrix1, assignNodeLabels);
		...
		SourceAndTerminusEdgeMatrices sourceTerminusMatrix2 = new SourceAndTerminusEdgeMatrices(matrix2, assignNodeLabels);
	...
	private static double[][] evaluateSumOfKroneckerProductsOfMatricesForX(
			double matrix1SourceEdge[][], double matrix2SourceEdge[][],
			double matrix1TerminusEdge[][], double matrix2TerminusEdge[][],
	...
	private void computeSimilarityMatricesPairIterationToConvergence(double updateXMatrix[][], double updateYMatrix[][]) {
		...
		while ((actualL1Value < previousL1Value + treshold && actualL1Value < previous2L1Value + treshold) || iteration % 2 != 0 || iteration < 15000) {
			newUpdatedXMatrix = GraphsVertexEdgeSimilarities.evaluateSumOfKroneckerProductsOfMatricesForX(
					this.sourceEdgeMatrix1, this.sourceEdgeMatrix2, 
					this.terminusEdgeMatrix1, this.terminusEdgeMatrix2, updateYMatrix);
			newUpdatedYMatrix = GraphsVertexEdgeSimilarities.evaluateSumOfKroneckerProductsOfMatricesForY(
